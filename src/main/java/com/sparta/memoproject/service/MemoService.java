...
public class MemoService {
    ...
    public List<MemoMainResponseDto> readMemo() {
        ...
        for (Memo memo : memos) {
            Long heartCnt = heartRepository.countByMemo(memo);
            Long commentCnt = commentRepository.countByMemo(memo);
            responseDto.add(new MemoMainResponseDto(memo, heartCnt, commentCnt));
        }
        return responseDto;
    }
